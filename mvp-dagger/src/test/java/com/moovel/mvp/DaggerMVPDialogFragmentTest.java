...
import com.moovel.mvp.dummy.DummyTestDaggerMVPDialogFragment;
...
public class DaggerMVPDialogFragmentTest {

    private MVPDialogFragment subject;

    @Before
    public void setUp() throws Exception {
        subject = new DummyTestDaggerMVPDialogFragment();
