...
import com.moovel.mvp.dummy.DummyTestDaggerMVPActivity;
...
public class DaggerMVPActivityTest {

    private MVPActivity subject;

    @Before
    public void setUp() throws Exception {
        subject = Robolectric.buildActivity(DummyTestDaggerMVPActivity.class).create().get();
    }
